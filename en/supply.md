...
* [World Bank Statistical Capacity Indicator](http://go.worldbank.org/UI0WGV6KW0). This tool provides an overview of the statistical capacity of developing countries, based on a diagnostic framework that assesses the capacity of statistical systems. The Statistical Capacity Indicator website allows users to visualize changes in a country's statistical capacity over time.
