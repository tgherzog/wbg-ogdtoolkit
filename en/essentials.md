...
2. The data must be **technically open**, which means they must be published in electronic formats that are [machine readable and non-proprietary](http://opendatahandbook.org/guide/en/appendices/file-formats),
